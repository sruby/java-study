package io.github.sruby.caffeine;

import com.github.benmanes.caffeine.cache.*;
import io.github.sruby.cache.caffeine.DataObject;
...
public class CaffeineUnitTest {
    ...
    public void givenCache_whenPopulate_thenValueStored() {
        ...
        Cache<String, DataObject> cache2 = Caffeine.newBuilder()
                .expireAfterWrite(1, TimeUnit.MINUTES).maximumSize(100).build();
        ...
        DataObject ifPresent = cache2.getIfPresent(key);
